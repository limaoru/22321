...
# YOLO 模型配置（在原有基础上统一升一档：m→l，n→s）
SEG_MODEL = "yolov8l-seg.pt"
...
def start_advanced_store_analytics():
    ...
    print(f"🔥 5060 零售视界启动！分割: {SEG_MODEL} | 姿态: {POSE_MODEL} | imgsz={INFER_IMGSZ}")
